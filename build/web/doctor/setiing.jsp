    <%-- 
    Document   : setiing
    Created on : Jul 6, 2023, 1:06:07 PM
    Author     : user
--%>
...
<% 
    ...
    String doc_email = "tasia@gmial.com"; // <------ [UPDATE] MAKE SURE THIS UNTUK TUKAR KEPADA SESSIONDATA
%>

<!--[SQL] FETCHING THE DATA FROM THE DATABASE-->
<!-- MAKE SURE UNTUK AMBIL DATA FROM REQUEST SERVLET-->
<sql:query var="result" dataSource="${myDatasource}">
    SELECT docemail FROM doctor WHERE docemail = '<%= doc_email %>'
</sql:query>
            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-settings  menu-active menu-icon-settings-active">
                        <a href="setiing.jsp" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Settings</p></a></div>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <table class="filter-container" style="border: none;" border="0">
                            ...
                            <tr>
                                <td style="width: 25%;">
                                    <a href="editDoctor.jsp" class="non-style-link">
                            ...
                            <tr>
                            <td style="width: 25%;">
                                    <a href="AddDoctorServlet?id=${row[0]}>" class="non-style-link">
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex;">
