                ...
                <table class="menu-container" border="0">
                    ...
                    <tr class="menu-row" >
                        <td class="menu-btn menu-icon-home menu-active menu-icon-home-active" >
                            <a href="admin.jsp" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Dashboard</p></a></div><a>
                        </td>
                    </tr>

                    <tr class="menu-row" >
                        <td class="menu-btn menu-icon-session">
                            <a href="addDoctors.jsp" class="non-style-link-menu"><div><p class="menu-text">Doctors</p></div></a>
                        </td>
                    </tr>
                    <tr class="menu-row" >
                        <td class="menu-btn menu-icon-appoinment">
                            <a href="scheduleAdmin.jsp" class="non-style-link-menu"><div><p class="menu-text">Schedule</p></a></div>
                        </td>
                    </tr>
                    <tr class="menu-row" >
                        <td class="menu-btn menu-icon-patient">
                            <a href="patientAdmin.jsp" class="non-style-link-menu"><div><p class="menu-text">Patients</p></a></div>
                        </td>
                    </tr>
                </table>
            </div>
